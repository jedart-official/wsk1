...
Route::post('/session/expired', [\App\Http\Controllers\app\SessionController::class, 'actionExpired']);
Route::post('/session/activity', [\App\Http\Controllers\app\SessionController::class, 'actionLastActive']);
